...
1. Install Add Link to Copied Text plugin either via the WordPress.org plugin directory, or by uploading the add_link_on_copy folder to `/wp-content/plugins/` directory at your server
